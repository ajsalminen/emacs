...
(defun color-theme-invaders ()
  ...
  (color-theme-install
   '(color-theme-invaders
     ...
     (font-lock-comment-delimiter-face ((t (:italic t :background "1e1e27" :foreground "#708090" :slant italic))))
     (font-lock-comment-face ((t (:italic t :foreground "#708090" :slant italic))))
     ...
     (font-lock-keyword-face ((t (:bold t :foreground "#c080d0" :weight bold))))
     ...
     (font-lock-string-face ((t (:background "#404040" :foreground "#ffcd8b"))))
