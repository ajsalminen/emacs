...
;;
;; For example, META-s (fastnav-jump-to-char-forward) highlights the next occurrences of
...
;;
;; The fastnav-sprint-forward/backward commands apply iterative jumping until return/C-G
